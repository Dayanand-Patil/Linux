...
static struct class *veda_class; // define class ptr
static dev_t mydev; // define device struct
static int inuse = 0;
...
major is the major number of interest, name is the name of the driver (it appears in /proc/devices), and fops is the default file_operations structure
*/
